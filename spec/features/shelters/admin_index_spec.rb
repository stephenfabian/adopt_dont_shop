...
RSpec.describe 'Admin Index' do
  ...
  describe 'Admin Index shelters with pending applications' do
    it 'When I visit /admin/shelters, I see the name of every shelter that has a pending application' do
      ...
      shelter2 = Shelter.create!(foster_program: TRUE, name: "Karen's Shelter", city: "Madison Heights", rank: 80)
      shelter3 = Shelter.create!(foster_program: TRUE, name: "The Free shelter", city: "Madison Heights", rank: 80)
      ...
      dog3 = shelter3.pets.create!(adoptable: TRUE, age: 100, breed: "Huge-dog", name: "Roger")
      ...
      bill = Application.create!(name: "Bill Pedro", street_address: "25 miracle st", city: "bouldor", state: "CO",status: "Pending", zip_code: "12347")
      al = Application.create!(name: "Al Stevem", street_address: "4 ice cream lane", city: "bouldor", state: "CO",status: "In Progress", zip_code: "12347")
      ...
      ApplicationPet.create!(pet_id: dog3.id, application_id: bill.id)
